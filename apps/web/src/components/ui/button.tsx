...
const buttonVariants = cva(
    ...
    'transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-neutral-300 ' +
    'disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 ' +
    '[&_svg]:shrink-0',
    {
        variants: {
            variant: {
                default: 'bg-accent-500 text-white shadow hover:bg-accent-600',
                destructive: 'bg-red-600 text-white shadow-sm hover:bg-red-700',
                outline:
                    'border border-neutral-700 bg-transparent shadow-sm hover:bg-neutral-800 ' +
                    'text-neutral-100',
